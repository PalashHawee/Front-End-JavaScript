...
//Setting maximum length for sliding
...
//Next slide func
const nextSlide = () => {
  //Checking if the slide reach max slide
...
//Implementing key press slides
document.addEventListener('keydown', e => {
  if (e.key === 'ArrowLeft') prevSlide();
  // or use short circuiting method
  e.key === 'ArrowRight' && nextSlide();
});

//Dots Operations for Carousel slide
const dotContainer = document.querySelector('.dots');

//Acitvate dots operations active class
...
//Event Delagation method for dot operations
